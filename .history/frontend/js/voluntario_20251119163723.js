        ...
        .then(data => {
            ...
            data.data.forEach(c => {
                ...
                div.querySelector('.link-comunidade').addEventListener('click', () => {
                    // Salva a comunidade como usuarioLogado para simular login como comunidade
                    const comunidadeUsuario = {
                        id: c.id,
                        ...
                        telefone: c.telefone,
                        endereco: c.endereco,
                        num_criancas_jovens: c.num_criancas_jovens,
                        faixa_etaria_aprox: c.faixa_etaria_aprox,
                        possui_estrutura: c.possui_estrutura,
                        descricao: c.descricao,
                        senha: c.senha,
                        data_cadastro: c.data_cadastro,
                        tipo: 'comunidade'
                    };
                    localStorage.setItem('usuarioLogado', JSON.stringify(comunidadeUsuario));
